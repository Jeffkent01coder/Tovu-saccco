...
import com.jeff.tovusacco.databinding.ActivityNewCarFormBinding;
...
public class NewCarForm extends AppCompatActivity {

    private ActivityNewCarFormBinding binding;
    private final Calendar calendar = Calendar.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNewCarFormBinding.inflate(getLayoutInflater());
