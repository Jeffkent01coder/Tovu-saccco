...
import com.jeff.tovusacco.databinding.ActivitySchoolFeesFormBinding;
...
public class SchoolFeesForm extends AppCompatActivity {

    private ActivitySchoolFeesFormBinding binding;
    private final Calendar calendar = Calendar.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySchoolFeesFormBinding.inflate(getLayoutInflater());
