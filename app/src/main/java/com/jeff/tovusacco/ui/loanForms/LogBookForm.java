...
import com.jeff.tovusacco.databinding.ActivityLogBookFormBinding;
import com.jeff.tovusacco.ui.loan.BorrowAmount;

public class LogBookForm extends AppCompatActivity {
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == RESULT_OK) {
                        ...
                        Toast.makeText(LogBookForm.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
                }
            });

    private ActivityLogBookFormBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_log_book_form);
        binding = ActivityLogBookFormBinding.inflate(getLayoutInflater());
