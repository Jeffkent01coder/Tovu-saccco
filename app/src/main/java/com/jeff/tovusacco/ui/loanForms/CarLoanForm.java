...
import com.jeff.tovusacco.databinding.ActivityCarLoanFormBinding;
import com.jeff.tovusacco.ui.loan.BorrowAmount;

public class CarLoanForm extends AppCompatActivity {

    private ActivityCarLoanFormBinding binding;
    private Uri goalUri;
    private Uri cvUri;
    private Uri cv2Uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_loan_form);
        binding = ActivityCarLoanFormBinding.inflate(getLayoutInflater());
