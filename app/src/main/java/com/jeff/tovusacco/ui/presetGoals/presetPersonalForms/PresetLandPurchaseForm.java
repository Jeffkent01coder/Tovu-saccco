...
import com.jeff.tovusacco.databinding.ActivityPresetLandPurchaseFormBinding;
...
public class PresetLandPurchaseForm extends AppCompatActivity {

    private ActivityPresetLandPurchaseFormBinding binding;
    private final Calendar calendar = Calendar.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPresetLandPurchaseFormBinding.inflate(getLayoutInflater());
